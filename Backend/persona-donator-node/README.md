...
This is a sample template for persona-donator-node - Below is a brief explanation of what we have generated for you:
...
aws cloudformation describe-stacks \
    --stack-name persona-donator-node --query 'Stacks[].Outputs'
```
